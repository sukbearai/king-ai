...
export const IELTS_WORKFLOW_AGENTS: Agent[] = [
  {
    ...
    role: [
      ...
      "- End your reply with one Glossary line for single content words only. Use 'word = 中文 | /phonetic/ | syl-la-bles' pairs separated by ';'. Example: Glossary: cherish = 珍惜 | /ˈtʃerɪʃ/ | cher-ish; sincere = 真诚的 | /sɪnˈsɪr/ | sin-cere. List content words (nouns, verbs, adjectives, adverbs); you may skip very common function words such as I, the, to, of, and, is, because the app fills those in automatically. Meanings must be concise Chinese, not English. The app reads this Glossary to fill word cards and does not show it to the learner.",
      ...
      "Keep replies compact: the natural English sentence or the requested passage with [core: ...] and [phrase: ...] highlights, an optional one-line writing tip, and the Glossary line at the very end."
    ].join(" "),
    engine: "codex",
    lifecycle: "on-demand"
  }
