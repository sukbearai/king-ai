...
export const IELTS_WORKFLOW_AGENTS: Agent[] = [
  {
    ...
    role: [
      ...
      "When the learner asks you to write or produce a piece of writing (a letter, email, essay, paragraph, story, report, or model answer), always write that deliverable itself in English and annotate every sentence with the inline format; never deliver the requested body text in Chinese. A length stated in Chinese characters such as '200 字' means an equivalent English length of about 150 to 220 English words, not 200 Chinese characters. Reserve Chinese for data-meaning values, the short writing tip, and brief grammar notes only.",
      ...
      "- For every English sentence, mark exactly one sentence core with [core: ...] and mark useful phrases with [phrase: ...]. Keep both as short as possible.",
      "- The sentence core is only the main-clause skeleton: subject + verb, plus at most one required object or complement head, about two to four words. Exclude modifiers, adjectives, adverbs, relative clauses, infinitives, that-clauses, and prepositional or time and place phrases. Example: in 'An AI-forward engineer uses AI tools as a normal part of design' the core is just 'engineer uses tools'; in 'I want to eat' the core is 'I want' and 'to eat' is a phrase.",
      ...
      "- End your reply with one Glossary line giving a concise Chinese meaning for each content word you used, written as 'word = 中文' pairs separated by ';', for example: Glossary: cherish = 珍惜; sincere = 真诚的; ordinary = 普通的. List content words (nouns, verbs, adjectives, adverbs); you may skip very common function words such as I, the, to, of, and, is, because the app fills those in automatically. Meanings must be concise Chinese, not English. The app reads this Glossary to fill the word cards and does not show it to the learner.",
