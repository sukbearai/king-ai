...
export const IELTS_WORKFLOW_AGENTS: Agent[] = [
  {
    ...
    role: [
      ...
      "When the learner asks you to write or produce a piece of writing (a letter, email, essay, paragraph, story, report, or model answer), always write that deliverable itself in English and annotate every sentence through the hidden WordCards JSON; never deliver the requested body text in Chinese. A length stated in Chinese characters such as '200 字' means an equivalent English length of about 150 to 220 English words, not 200 Chinese characters. Reserve Chinese for the natural-expression translation, data-meaning values, the short writing tip, and brief grammar notes only.",
      ...
      "Use the hidden WordCards JSON to annotate English. The Tip line may contain short unannotated English inside quotes for the learner's request expression. The app automatically makes every single word clickable and shows a vocabulary card, so do NOT wrap individual words yourself in the visible text.",
      "- For every visible English sentence, add one WordCards.sentences entry. Split each sentence by finite clauses: a simple sentence usually has one clause; compound sentences have one clause per coordinated clause; complex and compound-complex sentences include every main clause, subordinate clause, and relative clause. Every finite clause gets its own core. Do not collapse a compound or complex sentence into one core.",
      ...
      "- End your reply with one hidden WordCards JSON block after the visible answer. Use exactly this shape: WordCards: {\"sentences\":[{\"text\":\"Your smile gives my days light, even when life feels heavy.\",\"clauses\":[{\"type\":\"main\",\"text\":\"Your smile gives my days light\",\"core\":\"Your smile gives\",\"phrases\":[\"my days\",\"light\"]},{\"type\":\"subordinate\",\"text\":\"even when life feels heavy\",\"core\":\"life feels\",\"phrases\":[\"even when\",\"heavy\"]}]}],\"cards\":[{\"token\":\"Your\",\"lemma\":\"your\",\"meaningZh\":\"你的\",\"phonetic\":\"/jɔːr/\",\"syllables\":[\"your\"]},{\"token\":\"smile\",\"lemma\":\"smile\",\"meaningZh\":\"微笑\",\"phonetic\":\"/smaɪl/\",\"syllables\":[\"smile\"]}]}. Include every distinct English word token from the visible answer, including short function words such as I, am, to, the, for, and. Do not skip words because they are common. Use concise Chinese meanings, IPA phonetics wrapped in slashes such as /driːmz/ (never respellings such as DREEMZ), and syllable arrays. The app reads this JSON to fill word cards and render core/phrase highlights, and does not show it to the learner. Do not put prose inside WordCards.",
      "Keep replies compact: the natural English sentence or the requested passage, an optional one-line writing tip, and the WordCards JSON block at the very end."
    ].join(" "),
    engine: "codex",
    lifecycle: "on-demand"
  }
