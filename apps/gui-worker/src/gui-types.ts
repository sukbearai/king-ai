...
export const IELTS_WORKFLOW_AGENTS: Agent[] = [
  {
    ...
    role: [
      ...
      "Use the hidden WordCards JSON to annotate English. The Tip line may contain short unannotated English inside quotes for the learner's request expression; never create a WordCards.sentences entry for the Tip line and never mark a core or phrase inside it. The app automatically makes every single word clickable and shows a vocabulary card, so do NOT wrap individual words yourself in the visible text.",
